                      ...
                      <div className='lg:w-4/5 mx-auto flex flex-wrap'>
                        {photoes.length > 0 && (
                          <div className='lg:w-1/3 w-full lg:h-auto h-auto object-cover object-center rounded-md'>
                            <Carousel showThumbs={false} autoPlay={true} showArrows={false} infiniteLoop={true} showIndicators={photoes.length !== 1} showStatus={photoes.length !== 1} className='rounded-lg'>
                              {photoes.map((e, index) => (
                                <>
                                {fileExt(e) == 'video'?
                        ...
                        <div className='lg:w-1/2 w-full lg:pl-10 mt-3 lg:mt-0 '>
                          ...
                          {eventTicketDetail.event_about && (
                            <div className='mt-5'>
                              ...
                              <p className='leading-relaxed ml-1 mr-3'>
                                {eventTicketDetail.event_about.length > 250 ? (
                                  <>
                                    <span dangerouslySetInnerHTML={{ __html: showMore ? eventTicketDetail.event_about : `${eventTicketDetail.event_about.substring(0, 230) + ' ...  '}` }} />
                                    <span className='btn text-[#753FF6] cursor-pointer font-semibold' onClick={() => setShowMore(!showMore)}>
                                      {showMore ? '  Show Less' : '  Show more'}
                                    </span>
                                  </>
                                ) : (
                                  <span dangerouslySetInnerHTML={{ __html: eventTicketDetail.event_about }} />
                                )}
                              </p>
                            </div>
                          )}
                      ...
                      <>
                        ...
                        <div className='container px-1 py-0 mx-auto lg:w-3/6'>
                          ...
                          {eventTicketDetail.tickets.map((item, index) => {
                            ...
                            return (
                              <div className='shadow p-3 mb-5 bg-white rounded border flex-col' key={index}>
                            ...
                            <>
                              {promoCode.length > 0 && promoCodeDiscount > 0 ? (
                                ...
                                <div className={`promo-view mt-3 ${promoCode != '' ? `border border-violet-700` : `border`} shadow rounded p-1 relative`}>
                                  ...
                                  <Input className='form-control outline-0 p-2' placeholder='Promo Code' onChange={(e) => setPromoCode(e.target.value)} value={promoCode} autoCapitalize={'none'} maxLength={7} />
                          ...
                          <div className='row mt-2'>
                            <div className='col-sm-12'>
                              <Input className='form-control outline-0 p-2 border w-full rounded' placeholder='Email' onChange={(e) => setEmail(e.target.value)} value={email} autoCapitalize={'none'} />
                            </div>
                          </div>
                          <div className='row mt-2'>
                            <div className='col-sm-12'>
                              <Input className='form-control outline-0 p-2 border w-full rounded mt-1' placeholder='Confirm Email' onChange={(e) => setConfirmEmail(e.target.value)} value={confirmEmail} autoCapitalize={'none'} />
                            </div>
                          </div>
                          {/* -- More fields --- */}
                          <div className='row mt-3'>
                            <div className='col-sm-12'>
                              <Input className='form-control outline-0 p-2 border w-full rounded' placeholder='Phone' onChange={(e) => setPhone(e.target.value)} value={phone} autoCapitalize={'none'} />
                            </div>
                          </div>
                          <div className='mt-3 columns-2'>
                            <div className='col-sm-6'>
                              <Input className='form-control outline-0 p-2 border w-full rounded' placeholder='First name' onChange={(e) => setFirstName(e.target.value)} value={first_name} autoCapitalize={'none'} />
                            </div>
                            <div className='col-sm-6'>
                              <Input className='form-control outline-0 p-2 border w-full rounded' placeholder='Last name' onChange={(e) => setLastName(e.target.value)} value={last_name} autoCapitalize={'none'} />
                            </div>
                          </div>
                          ...
                          {parseFloat((totalPrice * (100 - promoCodeDiscount)) / 100) > 0 && first_name !== '' && last_name !== '' && email !== '' && phone !== '' && (
                            <>                              
                              ...
                              <div className='row mt-3'>
                                <div className='col-sm-12'>
                                  <Input className='outline-0 p-2 border w-full rounded' placeholder='Credit card number' onChange={(e) => setCardNo(cardNumberFormat(e.target.value))} value={card_no} autoCapitalize={'none'} maxLength={22} />
                                </div>
                              </div>
                              <div className='flex'>
                                <div className='col-sm-4 mr-1 w-full'>
                                  <Input className='outline-0 p-2 border w-full rounded mt-3' placeholder='MM/YY' onChange={(e) => setCardExp(cardExpFormat(e.target.value))} value={card_exp} autoCapitalize={'none'} maxLength={5} />
                                </div>
                                <div className='col-sm-4 mr-1 w-full'>
                                  <Input className='outline-0 p-2 border w-full rounded mt-3' placeholder='CVV' onChange={(e) => setCardCvv(e.target.value)} value={card_cvv} autoCapitalize={'none'} maxLength={4} />
                                </div>
                                <div className='col-sm-4 w-full'>
                                  <Input className='outline-0 p-2 border w-full rounded mt-3' placeholder='ZIP' onChange={(e) => setZip(e.target.value)} value={zip} autoCapitalize={'none'} maxLength={8} />
                                </div>
                              </div>
